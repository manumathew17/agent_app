                  ...
                  children: [
                    ...
                    Column(
                      ...
                      children: [
                        ...
                        Text(
                          widget.customerData.customerMobileNo,
                          style: generalText,
                        ),
                      ],
                    ),
                  ...
                  children: [
                    Ink(
                      ...
                      child: IconButton(
                        ...
                        color: primary,
                        onPressed: () {
                          GeneralUtils.makePhoneCall(widget.customerData.customerMobileNo);
                        },
                      ),
                    ),
                    Ink(
                      ...
                      child: IconButton(
                        ...
                        color: primary,
                        onPressed: () {
                          GeneralUtils.openWhatsApp(widget.customerData.customerMobileNo,
                              "Hello ${widget.customerData.customerName}\n I am from ${ConfigGetter.USERDETAILS}");
                        },
                      ),
                    ),
                  ],
          ...
          Padding(
            ...
            child: Container(
              ...
              child: Padding(
                ...
                child: Text(
                  "Number of Calls Made : ${widget.customerData.noOfCalls}",
                  style: heading14,
                ),
              ),
            ),
