...
class NotificationController {
  ...
  static Future<void> cancelNotifications() async {
    await AwesomeNotifications().cancel(17017);
  }

  static Future<void> cancelMissedCallNotifications() async {
    await AwesomeNotifications().cancel(122514);
  }
  ...
  static Future<void> createMissedCallNotification() async {
    bool isAllowed = await AwesomeNotifications().isNotificationAllowed();
    if (!isAllowed) isAllowed = await displayNotificationRationale();
    if (!isAllowed) return;
